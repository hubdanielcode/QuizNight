...
export type TokenWhereInput = {
  ...
  startToken?: Prisma.StringFilter<"Token"> | string
  tokenStatus?: Prisma.EnumTokenStatusFilter<"Token"> | $Enums.TokenStatus
}
...
export type TokenScalarWhereWithAggregatesInput = {
  ...
  startToken?: Prisma.StringWithAggregatesFilter<"Token"> | string
  tokenStatus?: Prisma.EnumTokenStatusWithAggregatesFilter<"Token"> | $Enums.TokenStatus
}
...
export type TokenUpdateInput = {
  startToken?: Prisma.StringFieldUpdateOperationsInput | string
  tokenStatus?: Prisma.EnumTokenStatusFieldUpdateOperationsInput | $Enums.TokenStatus
}
...
export type TokenOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"startToken" | "tokenStatus", ExtArgs["result"]["token"]>
...
export interface TokenDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `startToken`
   * const tokenWithStartTokenOnly = await prisma.token.findMany({ select: { startToken: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Tokens and only return the `startToken`
   * const tokenWithStartTokenOnly = await prisma.token.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Tokens and only return the `startToken`
   * const tokenWithStartTokenOnly = await prisma.token.updateManyAndReturn({
   *   select: { startToken: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface TokenFieldRefs {
  readonly startToken: Prisma.FieldRef<"Token", 'String'>
  readonly tokenStatus: Prisma.FieldRef<"Token", 'TokenStatus'>
}
